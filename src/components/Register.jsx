    ...
    return <>
        ...
        <div className="main-box">
            ...
            <div className="logo mobile-number">
                ...
                <input type="text" name id="hello-input" value={password} onChange={(e) => setPassword(e.target.value.trim())} placeholder="Password" />
            </div>
            <span style={{ fontSize: "13px", color: "red", display: passwordError ? "block" : "none" }}>Password is required</span>
            <div className="logo mobile-number">
                <img className="logo" src="/Images/promotion.png" alt="" />
                <input type="text" name id="hello-input" value={recommendation} onChange={(e) => setRecommendation(e.target.value.trim())} placeholder="Recommendation Code" />
            </div>

            <div className="privacy">
                <input type="checkbox" checked className="check-box" />
                <span>I agree
                    <span className="privacy-policy" style={{ color: 'blue' }}>
                        {" Privacy Policy"}
                    </span>
                </span>
            </div>
